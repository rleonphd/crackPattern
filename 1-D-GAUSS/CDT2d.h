...
void RandomIntersectionPolygon(CDT2d *, unsigned long, unsigned long, LINE, unsigned long);
void RandomIntersectionPolygonDisturbed(CDT2d *, unsigned long, unsigned long, LINE, double, unsigned long);
int STIT2dIso(CDT2d *, double, unsigned long);
int STIT2dAniso(CDT2d *, double, double *, double *, unsigned long, unsigned long);
int STIT2dAnisoDisturbed(CDT2d *, double, double *, double *, unsigned long, double, unsigned long);
int STIT2dAnisoEllip(CDT2d *, double, double, unsigned long);
...
void GaussIntersectionPolygon(CDT2d *, unsigned long, unsigned long, LINE , double , gsl_rng *, unsigned long);
void GaussIntersectionPolygonDisturbed(CDT2d *, unsigned long, unsigned long, LINE , double , gsl_rng *, double, unsigned long);
int STIT2dGauss(CDT2d *, double, double, unsigned long);
int STIT2dGaussDisturbed(CDT2d *, double, double, double, unsigned long);
